								...
								<#if var[3] == "是">
									...
									<#elseif var[1] == 'Text'>
										<div class="input-group input-group-sm mb-3" style="margin-top: -10px;">
                                            ...
                                            <textarea type="text" class="form-control" ref="${var[0] }" id="${var[0] }" v-model="pd.${var[0]}" maxlength="${var[5] }" placeholder="这里输入${var[2] }" title="${var[2] }"/></textarea>
                                        </div>
									<#else>
									<#if var[7] != 'null'>
										<div class="input-group input-group-sm mb-3" style="margin-top: -10px;">
...
<script src="../../../../assets/js-v/${packageName2}/${objectNameLower}/${objectNameLower}_edit.js"></script>
    <#else>
<script type="text/javascript" src="../../../assets/js/jquery-1.7.2.js"></script>
<script type="text/javascript" src="../../../assets/js/pre-loader.js"></script>
<script src="../../../assets/plugins/sweetalert/js/sweetalert.min.js"></script>
...
<!-- 表单验证提示 -->
<script src="../../../assets/js/jquery.tips.js"></script>
<script src="../../../assets/js-v/jquery.tips.js"></script>
<script src="../../../assets/js-v/${packageName2}/${objectNameLower}/${objectNameLower}_edit.js"></script>
</#if>
